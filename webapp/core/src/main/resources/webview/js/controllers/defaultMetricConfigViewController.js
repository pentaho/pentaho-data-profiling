  ...
  appControllers.controller('DefaultMetricConfigViewController', [
    ...
    function ($scope, profileAppService) {
      ...
      profileAppService.profileService.metricContributorResource.getDefaultMetricContributorConfig({}, function (metricContributorConfig) {
        profileAppService.defaultMetricConfigViewService.metricManagerContributors = metricContributorConfig.metricManagerContributors;
        profileAppService.defaultMetricConfigViewService.metricContributors = metricContributorConfig.metricContributors;
      });
    }
  ])
});