...
This will build, unit test, and package the whole project (all of the sub-modules). The artifact will be generated in: ```assemblies/karaf/target```
...
In addition to redirect any test log to the file log.txt
```
$ mvn clean install -DrunsITs >log.txt
 ```
