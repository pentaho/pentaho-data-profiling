...
public class MetricManagerBasedMetricContributorTest {
  ...
  public void setup() {
    ...
    metricManagerBasedMetricContributor = new MetricManagerBasedMetricContributor();
  }
  ...
  public void testProcess() throws ProfileActionException {
    ...
    metricManagerBasedMetricContributor.implAdded( metricManagerContributor, new HashMap() );
  ...
  public void testGetProfileFieldProperties() throws ProfileActionException {
    ...
    when( metricManagerContributor.getProfileFieldProperties() ).thenReturn( Arrays.asList( profileFieldProperty ) );
  ...
  @Test
  public void testImplRemoved() {
    when( metricManagerContributor.getTypes() )
      .thenReturn( new HashSet<String>( Arrays.asList( String.class.getCanonicalName() ) ) );
    metricManagerBasedMetricContributor.implAdded( metricManagerContributor, new HashMap() );
    metricManagerBasedMetricContributor.implRemoved( metricManagerContributor, new HashMap() );
    metricManagerBasedMetricContributor.getProfileFieldProperties();
    verify( metricManagerContributor, times( 2 ) ).getTypes();
