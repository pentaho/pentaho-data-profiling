...
public interface MetricContributor {
   ...
   * @param value   the actual data value provided by a data source (along with any relevant metadata)
   * @throws ProfileActionException if a problem occurs
   */
  void processField( DataSourceFieldManager manager, DataSourceFieldValue value ) throws ProfileActionException;
