...
/**
 * Class representing a field being processed from a data source. Keeps track of
 * types seen for the field and their associated metrics
 * <p/>
...
public class DataSourceField {
  ...
  /**
   * values to base this DataSourceField on (typically sourced from a
   * ProfilingField)
   */
  ...
  /**
   * Construct a DataSourceField from a map of values. metric information
   * associated with different types is extracted (if present).
   *
  ...
  /**
   * Construct a DataSourceField from information stored in a ProfilingField (in
   * particular, the metric information for each known type)
   *
  ...
  /**
   * Get a list of all the metric managers currently in use by this
   * DataSourceField
   *
  ...
  /**
   * Get the metric manager associated with the named type. Returns null if the
   * named type has not been seen in this field.
   *
   * @param typeName the name of the type to get the associated manager for
   * @return the manager for the type, or null if the type has not been seen by
   * this field
   */
  ...
  /**
   * Get a ProfilingField encapsulating the current state of profiling types
   * seen for this field.
   *
   ...
   *
   * @param typeName the name of the type to get the associated manager for
   * @param create   true if a manager should be created in the case where the
   *                 named type has not yet been seen
