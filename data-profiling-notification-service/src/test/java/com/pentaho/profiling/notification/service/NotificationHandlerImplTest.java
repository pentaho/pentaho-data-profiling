...
public class NotificationHandlerImplTest {
  ...
  @Test
  public void testNotificationProviderConstructor() {
    assertEquals( notificationProvider, new NotificationHandlerImpl( notificationProvider ).getNotificationProvider() );
  }

  @Test
  public void testGetInterestedIds() {
    ...
    assertEquals( 1, notificationHandler.getInterestedIds().size() );
    assertTrue( notificationHandler.getInterestedIds().contains( "ID" ) );
  }
